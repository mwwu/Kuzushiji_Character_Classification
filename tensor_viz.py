...
def visualize_layer(model,
    ...
    def _draw_filters(filters, n=None):
        ...
        MARGIN = 5
        width = n * 79 + (n - 1) * MARGIN
        height = n * 79 + (n - 1) * MARGIN
        ...
        for i in range(n):
            for j in range(n):
                img, _ = filters[i * n + j]
                width_margin = (79 + MARGIN) * i
                height_margin = (79 + MARGIN) * j
                stitched_filters[
                    width_margin: width_margin + 79,
                    height_margin: height_margin + 79, :] = img
...
if __name__ == '__main__':
    ...
    LAYER_NAME = 'conv2d_1' # conv2d_2, dense_1, dense_2
